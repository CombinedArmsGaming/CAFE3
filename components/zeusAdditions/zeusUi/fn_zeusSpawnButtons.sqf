...
missionNamespace setVariable ["f_zeus_ctrls", _ctrls];
_id = 500;
...
_btn buttonSetAction 'if (!isNil "f_zeus_defToSpawn") then {[f_zeus_defToSpawn] call f_fnc_zeusDoSpawn;};';
_btn ctrlCommit 0;
...
_unitsList ctrlAddEventHandler ["LBSelChanged",
{
	...
	if (lbSize _list > 0) then
	{
		...
		_defs = f_zeus_listUnits;
		_def = _defs select _sel;

		f_zeus_defToSpawn = _def;
...
f_zeus_unitsList_idc = ctrlIDC _unitsList;
...
[ctrlIDC _categoriesList] call f_fnc_zeusFillCategories;
_categoriesList ctrlAddEventHandler ["LBSelChanged",
{
	params ["_list", "_sel"];
	if (_sel < 0) exitWith {};

	_unitsListIDC = f_zeus_unitsList_idc;
	[_unitsListIDC, _sel] call f_fnc_zeusFillUnits;
...
f_zeus_guerrillaBtn_idc = ctrlIDC _guerrillaBtn;
...
_guerrillaBtn buttonSetAction '[f_zeus_guerrillaBtn_idc, "zeus_spawn_guerrillas", !zeus_spawn_guerrillas, "Guerrilla"] call f_fnc_updateButtonToggleState;';
[f_zeus_guerrillaBtn_idc, "zeus_spawn_guerrillas", zeus_spawn_guerrillas, "Guerrilla"] call f_fnc_updateButtonToggleState;
...
f_zeus_suppressBtn_idc = ctrlIDC _suppressBtn;
...
_suppressBtn buttonSetAction '[f_zeus_suppressBtn_idc, "zeus_spawn_suppress", !zeus_spawn_suppress, "Suppressive"] call f_fnc_updateButtonToggleState;';
[f_zeus_suppressBtn_idc, "zeus_spawn_suppress", zeus_spawn_suppress, "Suppressive"] call f_fnc_updateButtonToggleState;
...
f_zeus_hideBtn_idc = ctrlIDC _hideBtn;
//ZU_HIDE = _hideBtn;
_hideBtn ctrlSetPosition [ 0.095, 1.144, 0.134, 0.04 ];
_hideBtn ctrlSetText "Hide";
_hideBtn buttonSetAction '[f_zeus_hideBtn_idc, "zeus_hide_ui", !zeus_hide_ui, "Hide"] call f_fnc_updateButtonToggleState; [zeus_hide_ui] spawn f_fnc_setZeusUiHidden;';
[f_zeus_hideBtn_idc, "zeus_hide_ui", zeus_hide_ui, "Hide"] call f_fnc_updateButtonToggleState;
[zeus_hide_ui] spawn f_fnc_setZeusUiHidden;
...
f_zeus_vcomBtn_idc = ctrlIDC _vcomBtn;
//ZU_VCOM = _vcomBtn;
_vcomBtn ctrlSetPosition [ 0.095, 1.094, 0.134, 0.04 ];
_vcomBtn ctrlSetText "Hide";
_vcomBtn buttonSetAction '[f_zeus_vcomBtn_idc, "zeus_spawn_vcom", !zeus_spawn_vcom, "VCOM"] call f_fnc_updateButtonToggleState;';
[f_zeus_vcomBtn_idc, "zeus_spawn_vcom", zeus_spawn_vcom, "VCOM"] call f_fnc_updateButtonToggleState;
[zeus_spawn_vcom] spawn f_fnc_setZeusUiHidden;
