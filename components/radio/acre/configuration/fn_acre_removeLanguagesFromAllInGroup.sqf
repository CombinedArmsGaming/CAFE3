...
{
    {
        [_languages, _side, _role, _x] call f_fnc_acre_removeLanguagesFromAllInGroup;
    }
    forEach _groupName;
};

private _languagesKey = format ["--%1::%2::%3", [_side] call f_fnc_sideToString, toUpper _groupName, ALL];
