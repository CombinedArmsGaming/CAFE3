...
========================================================================================================================================
        DESCRIPTION:
                ...
                I recommend using f_fnc_groupGuerrillaAI instead, so you won't have to worry about this weird stuff.
...
========================================================================================================================================
        EXAMPLES:
                        [this] spawn f_fnc_unitGuerrillaAI                             // inside a unit's init field in 3DEN,
                ...
                ------------------------------------------------------------------------------------------------------------------------
                        {
                                [_x] spawn f_fnc_unitGuerrillaAI                       // inside a script
                        } forEach allUnits;
                        // Enables guerrilla AI on all spawned units in the mission (!)
                ------------------------------------------------------------------------------------------------------------------------
                        [this, false, 0, 100, 99999] spawn f_fnc_unitGuerrillaAI	// inside a unit's init field
