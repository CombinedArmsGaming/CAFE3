...
========================================================================================================================================
        DESCRIPTION:
                ...
                For most intents and purposes, you should be using this function rather than f_fnc_unitSuppressiveAI.
...
========================================================================================================================================
        EXAMPLES:
                        [this] spawn f_fnc_groupSuppressiveAI				// inside a unit's init field in 3DEN,
                ...
                ------------------------------------------------------------------------------------------------------------------------
                        [_group, 10, 2] spawn f_fnc_groupSuppressiveAI               // inside a script, where _group is a group
...
isNil {
        ...
        if (!isServer) exitWith {
                ...
                _this remoteExec ["f_fnc_groupSuppressiveAI", 2, false];
        };
        ...
        {
                [_x, _suppressionMul, _suppressionDelayMul] MACRO_SPAWN(f_fnc_unitSuppressiveAI,"components\aiBehaviour\fn_unitSuppressiveAI.sqf");
        } forEach units _group;
};
