...
========================================================================================================================================
        DESCRIPTION:
                ...
                I recommend using f_fnc_groupSuppressiveAI instead, so you won't have to worry about this weird stuff.
...
========================================================================================================================================
        EXAMPLES:
                        [this] spawn f_fnc_unitSuppressiveAI				// inside a unit's init field in 3DEN,
                ...
                ------------------------------------------------------------------------------------------------------------------------
                        [_unit, 10, 2] spawn f_fnc_unitSuppressiveAI                 // inside a script, where _unit is a unit
                ...
                [_unit, _weapon, _muzzle, _mode, _unit getVariable ["Cre8ive_SuppressiveAI_CycleDelay", 0.1]] spawn {
                        ...
                        if (_rounds > 0) then {
                                for "_i" from 1 to _rounds do {
                                        ...
                                        [_unit, _muzzle, _mode] MACRO_CALL(f_fnc_fireWeaponSafe,"components\aiBehaviour\fn_fireWeaponSafe.sqf");
                                };
                        };
