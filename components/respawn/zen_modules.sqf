call
{
    ...
    private _makeSquare = { _this call f_fnc_zen_respawnRandomAtSquare };
    [_category, "Respawn Random at Cursor", _makeSquare] call zen_custom_modules_fnc_register;

	private _makeChosenSquare = { _this call f_fnc_zen_createRespawnSquare };
    [_category, "Respawn Player at Cursor", _makeChosenSquare] call zen_custom_modules_fnc_register;
