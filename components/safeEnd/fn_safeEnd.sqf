/*
    ...
    Usage:
        [position, Allow Vehicles - default true, Spacing in meters - default 0 (auto), time invincible in minutes - default 5] execVM "SafeEnd.sqf";
*/
    ...
    {
        {
            _x setPos
            [
                _xCount - (_spacing/2) + random _spacing,
