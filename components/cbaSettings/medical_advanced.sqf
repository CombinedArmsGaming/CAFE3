...
force ace_medical_treatment_treatmentTimeTrainedIV = 3.015;
force ace_medical_treatment_treatmentTimeTrainedSplint = 4.005;
force ace_medical_treatment_treatmentTimeTrainedTourniquet = 1.01;
