...
if !(_launcherArray isEqualType [] and {count _launcherArray > 4 and {(_launcherArray select 4) isEqualType []}}) exitWith
{
...
if !(_launcherAmmo isEqualType [] and {count _launcherAmmo > 0 and {(_launcherAmmo select 0) isEqualType ""}}) exitWith
{
