...
if !(_launcherArray isEqualType [] and {count _launcherArray > 4 and {typeName (_launcherArray select 4) == "ARRAY"}}) exitWith
{
...
if !(_launcherAmmo isEqualType [] and {count _launcherAmmo > 0 and {typeName (_launcherAmmo select 0) == "STRING"}}) exitWith
{
