...
if !(_pistolArray isEqualType [] and {count _pistolArray > 4 and {(_pistolArray select 4) isEqualType []}}) exitWith
{
...
if !(_pistolAmmo isEqualType [] and {count _pistolAmmo > 0 and {(_pistolAmmo select 0) isEqualType ""}}) exitWith
{
