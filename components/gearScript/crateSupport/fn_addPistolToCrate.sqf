...
if !(_pistolArray isEqualType [] and {count _pistolArray > 1 and {typeName (_pistolArray select 0) == "STRING"}}) exitWith
{
...
_pistolName = _pistolArray select 0;

_itemEntry = [_pistolName, _amount];
