...
#define RESPAWN_TYPE_WAVES "RespawnWaves"
#define RESPAWN_TYPE_NONE "NoRespawns"

#define RESPAWN_MODE_DISABLED 0
#define RESPAWN_MODE_BASE 1
#define RESPAWN_MODE_COMMANDER 2

#define RESPAWN_REJOIN_OLD_SQUAD 0
#define RESPAWN_JOIN_REINFORCEMENT_SQUAD 1

#define ORIGINAL_SQUAD "<original>"

#define WAVEINFO_ISACTIVE 0
#define WAVEINFO_SPAWNAT 1
#define WAVEINFO_JOINGROUP 2
#define WAVEINFO_TIMESTARTED 3

#define RESPAWN_TYPE(SIDE) GET_RESPAWN_WAVE_VAL(SIDE,Type,RESPAWN_TYPE_NONE)
#define SET_RESPAWN_TYPE(SIDE,TYPE) SET_RESPAWN_WAVE_VAL(SIDE,Type,TYPE)
...
#define RESPAWN_MODE(SIDE) GET_RESPAWN_WAVE_VAL(SIDE,Mode,RESPAWN_MODE_DISABLED)
...
#define RESPAWN_SQUAD_MODE(SIDE) GET_RESPAWN_WAVE_VAL(SIDE,RejoinSquad,RESPAWN_REJOIN_OLD_SQUAD)
#define SET_RESPAWN_SQUAD_MODE(SIDE,MODE) SET_RESPAWN_WAVE_VAL(SIDE,RejoinSquad,MODE)
...
#define SET_RESPAWN_WAVE(SIDE,WAVEARRAY) \
    ...
    SET_LAST_RESPAWN_TIME(SIDE,serverTime)
...
#define TIME_UNTIL_RESPAWN_READY(SIDE) (RESPAWN_WAVE_DURATION(SIDE) + RESPAWN_WAVE_COOLDOWN(SIDE) + LAST_RESPAWN_TIME(SIDE) - serverTime)


#define COPY_RESPAWN_CONFIG(TO,FROM) \
        SET_RESPAWN_MODE(TO,RESPAWN_MODE(FROM)); \
        SET_RESPAWN_SQUAD_MODE(TO,RESPAWN_SQUAD_MODE(FROM)); \
