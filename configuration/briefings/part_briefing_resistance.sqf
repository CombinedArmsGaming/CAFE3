...
//[resistance,["task2"],["Good luck finding this cookie","Find Cookie","cookiemarker2"],objNull,1,3,true] call BIS_fnc_taskCreate //Task without a map location

//However, we don't use the civilian or resistance terms, as this is the resistance briefing file, instead, we can do something like this:
...
//The two above would create two tasks for the Indfor team, it would create tasks for any player who also has this file directed at them, this is why 
