...
f_var_respawnMode        = 1;      // Respawn modes: 0: Off, 1: Base respawn, 2: Spawn on Commanding Officer
...
f_var_respawnMessage     = "Reinforcements arrived at HQ, awaiting airlift.";     // Message to show in the chat when a respawn wave occurs.
