...
missionNamespace setVariable ['ca_wavecooldown',10, true]; // Seconds between each wave plus wavetime below
...
missionNamespace setVariable ['ca_respawnmsg',"Reinforcements have arrived.", true]; // Message to show in the chat when a respawn wave occurs.
