...
MAKE_SQUAD_EDITABLE(CASTER);
SET_SQUAD_COLOUR(CASTER,ORANGE);
SET_SQUAD_NAME(CASTER,"Caster");

MAKE_SQUAD_EDITABLE(FALCON);
SET_SQUAD_COLOUR(FALCON,MAGENTA);
SET_SQUAD_NAME(FALCON,"Falcon");

MAKE_SQUAD_EDITABLE(HAWK);
SET_SQUAD_COLOUR(HAWK,PINK);
SET_SQUAD_NAME(HAWK,"Hawk");

MAKE_SQUAD_EDITABLE(SCALPEL);
SET_SQUAD_COLOUR(SCALPEL,GREEN);
SET_SQUAD_NAME(SCALPEL,"Scalpel");