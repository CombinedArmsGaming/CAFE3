...
SET_SQUAD_IMPORTANT(TANGO-2,true);
SET_SQUAD_COLOUR(TANGO-2,COLOUR_BLUE);

SET_SQUAD_IMPORTANT(TANGO-3,true);
SET_SQUAD_COLOUR(TANGO-3,COLOUR_GREEN);

SET_SQUAD_IMPORTANT(TANGO,true);
SET_SQUAD_COLOUR(TANGO,COLOUR_YELLOW);
