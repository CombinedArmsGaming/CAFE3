...
// CA2 downtime spectate cam modes. If the comment below is enabled, unconscious players are restricted to 1PP and 3PP, dead players have all spectate modes .
// To disable this comment-out or delete the line below INSTEAD of setting it to 0.
 #define CA2_SPECTATE_LIMITED 1

// CA2 downtime spectate cam modes. If the comment below is enabled, all modes will be available to players.
