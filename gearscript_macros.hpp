...
#define SET_GUNBAG_CONTENTS(NAME,CONTENTS) [#FACTION,#NAME,CONTENTS] call f_fnc_setGunbagVariableState
#define SET_GUNBAG_CONTENTS_DIRECT(SIDE,NAME,CONTENTS) SET_LOADOUT_ITEM_VAR_DYNAMIC(SIDE,NAME,"gunbag",CONTENTS)
