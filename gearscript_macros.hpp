...
#define FACEWEAR_DYNAMIC(SIDE, NAME) LOADOUT_ITEM_VAR_DYNAMIC(SIDE,NAME,"facewear")
#define FACEWEAR_FORCED_DYNAMIC(SIDE, NAME) (missionNamespace getVariable [format ["f_loadouts_%1_%2_%3", SIDE, NAME, "forceFacewear"], false])
...
#define FACEWEAR(NAME) LOADOUT_ITEM_VAR(NAME,facewear)
#define FACEWEAR_FORCED(NAME) LOADOUT_ITEM_VAR(NAME,forceFacewear)
...
#define ADD_FACEWEAR(NAME, ITEM) FACEWEAR(NAME) pushBack ITEM
#define FORCE_FACEWEAR(NAME) FACEWEAR_FORCED(NAME) = true
...
#define CLEAR_FACEWEAR(NAME) FACEWEAR(NAME) = []
...
#define COPY_FACEWEAR(NAME,OTHERNAME)\
    FACEWEAR(NAME) = +FACEWEAR(OTHERNAME)
